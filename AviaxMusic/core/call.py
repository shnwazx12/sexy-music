...
def _make_pytgcalls_client(name: str, session_string):
    """Return a (userbot, PyTgCalls) pair only if session_string is set."""
    ...
    return userbot, PyTgCalls(userbot, cache_duration=100)
...
class Call(PyTgCalls):
    def __init__(self):
        ...
        self.userbot1, self.one   = _make_pytgcalls_client("AviaxAss1", config.STRING1)
        self.userbot2, self.two   = _make_pytgcalls_client("AviaxAss2", config.STRING2)
        self.userbot3, self.three = _make_pytgcalls_client("AviaxAss3", config.STRING3)
        self.userbot4, self.four  = _make_pytgcalls_client("AviaxAss4", config.STRING4)
        self.userbot5, self.five  = _make_pytgcalls_client("AviaxAss5", config.STRING5)
    ...
    async def decorators(self):
        for string, client in [
            ...
            if not string or client is None:
                continue
            @client.on_update()
