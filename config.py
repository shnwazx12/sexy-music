...
# Owner / Logging
_owner = getenv("OWNER_ID", "0")
OWNER_ID = int(_owner) if _owner and _owner.isdigit() else 0
_log = getenv("LOG_GROUP_ID", "0")
LOG_GROUP_ID = int(_log) if _log and _log.lstrip("-").isdigit() else 0

# Render PORT - health server binds here
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/CyberPixelPro/AviaxMusic")
...
START_IMG_URL = getenv("START_IMG_URL", "https://files.catbox.moe/dkyy20.jpg")
